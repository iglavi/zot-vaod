...
# הורד בחזרה מ-20 ל-10 (בקשת המשתמש, 2/8/2026): 20 מסמכים מלאים על כל
# שאלה הם הגורם המרכזי לעלות ה-API (כ-35-50K טוקני קלט לשאלה, ברובם
# קונטקסט פסקי הדין) - זו הסיבה המרכזית לכך שיתרת ה-API נגמרה בפועל.
AI_MAX_DOCS = int(os.environ.get("ZOT_AI_MAX_DOCS", "10"))
